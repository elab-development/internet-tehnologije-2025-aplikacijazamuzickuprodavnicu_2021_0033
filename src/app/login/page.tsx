...
function LoginFormContent() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setErr(error instanceof Error ? error.message : "Greška pri prijavi.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white uppercase tracking-wide">Prijava</h1>
          <p className="text-gray-400 mt-2">Dobrodošli nazad u prodavnicu</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <Link href="/forgot-password" className="text-xs font-bold text-gray-400 hover:text-gray-600">
            ...
            >
              {loading ? <Loader2 className="animate-spin mx-auto" size={24} /> : "Prijavi se"}
            </button>
          </form>
          ...
          <div className="mt-6 text-center text-sm border-t border-gray-100 pt-6">
            <p className="text-gray-400">
              Nemate nalog?{" "}
              <Link href="/register" className="font-black text-gray-800 hover:underline">
                Registrujte se
              </Link>
            </p>
          </div>
